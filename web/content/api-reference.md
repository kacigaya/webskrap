...
| `WebSkrapSession` | A persistent browser context kept open across requests. Exposes `fetch()`, `search()`, `human_click()`, `human_type()`, `decline_cookies()`, and the underlying Playwright `context`. |
